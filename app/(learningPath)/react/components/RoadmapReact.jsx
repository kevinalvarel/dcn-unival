      ...
      <TracingBeam className="px-6">
        <div className="max-w-4xl mx-auto antialiased pt-4 relative">
          ...
          <div className="mb-16">
            ...
            <p className="text-lg text-neutral-600">{react.description}</p>
          </div>

          {/* Roadmap Phases */}
          {react.phases.map((phase, index) => (
            <div
              key={`phase-${index}`}
          ...
          {/* CTA Section */}
          <div className="mt-16 bg-linear-to-r from-green-50 to-green-100 rounded-2xl p-12 text-center">
